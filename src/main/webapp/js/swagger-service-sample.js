jQuery(function($) {
	...
	var swaggerService = new SwaggerService("http://localhost:8080/crsh.demo/api/v1/shell.json");
	//http://localhost:8080/crsh.demo/api/v1/shell.json
	//http://swagr.api.wordnik.com/v4/list.json
	swaggerService.init();
